...
def xml_lists_menu():
    ...
    addDir("[B][COLOR ffff0000]ITV[/COLOR] SPORT CHANNEL[/B]","http://xbmc.itvplus.net/LIVE/sport.m3u",101,addonpath + art + 'itvsport.png',2,True)
    try:
    ...
    addDir("[COLOR ffff0000]"+translate(40121)+"[/COLOR]",MainURL,107,addonpath + art + 'plus-menu.png',2,False)
